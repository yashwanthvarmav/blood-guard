      ...
      <div className="bg-white p-6 rounded-md shadow-md input-wrapper">
        ...
        {currentStep === 2 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                <label className="font-medium text-sm">Primary Phone number</label>
                <input
                  type="tel"
              ...
              <div className="flex flex-col">
                <label className="font-medium text-sm">Secondary Phone number</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="font-medium text-sm">Organization Email</label>
                <input
                  type="email"
                  placeholder="Email"
                  className="input-field p-3 w-full"
