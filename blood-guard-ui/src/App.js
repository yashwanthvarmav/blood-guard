...
function App() {
  ...
  const flow = {
    ...
    faq_answer_issues_platform: {
      message: "Reach out to our support team via the 'Help & Support' section on the dashboard or email us at bloodguardinfo@gmail.com.",
      options: ["Back to Questions", "Back to Organization Options"],
      chatDisabled: true,
  ...
  return (
    <div className={`${isAuthenticated ? "sm:mx-[1%]" : "sm:mx-[10%]"} h-screen`}>
      {loading && (
      ...
      <Routes>
        ...
        >
          ...
          />
              <Route
            path="/admin-dashboard/organization-list"
            exact
            element={
              <PrivateRoute>
                <OrgList type="ADMIN"/>
