    ...
    const html = `
        <div style="font-family: Arial, sans-serif; text-align: center; padding: 20px;">
            ...
            <p style="font-size: 14px; color: #666; margin-top: 20px;">
                ...
                <a href="mailto:bloodguardinfo@gmail.com" style="color: #e63946;">bloodguardinfo@gmail.com</a>.
            </p>
    ...
    const html = `
        <div style="font-family: Arial, sans-serif; text-align: center; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
            ...
            <p style="margin-top: 20px;">
                <a href="mailto:bloodguardinfo@gmail.com" style="text-decoration: none; color: #ffffff; background-color: #ff4747; padding: 10px 20px; border-radius: 5px;">Contact Support</a>
            </p>
...
async function sendEligibilityEmail(userId, eligibility, disqualification_reasons, disqualification_end_date) {
    ...
    html += `
            ...
            <p style="margin-top: 20px;">For any questions or assistance, feel free to contact us at <a href="mailto:bloodguardinfo@gmail.com" style="color: #ff4747;">bloodguardinfo@gmail.com</a>.</p>
